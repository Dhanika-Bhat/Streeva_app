...
const seedData = async () => {
    try {
        ...
        const products = [
            ...
            // Anita's Kitchen
            { store: stores[1]._id, name: 'South Indian delight', description: 'Traditional south indian food made containing all the ingredients that are required to make amazing south indian food.', price: 250, images: ['https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=600'], category: 'food', stock: 50, isFeatured: true },
            ...
            { store: stores[1]._id, name: 'Organic Honey (350ml)', description: 'Pure wild honey sourced from Karnataka forests. Unprocessed and nutrient-rich.', price: 450, images: ['https://www.google.com/imgres?q=give%20me%20free%20link%20of%20images%20of%20honey&imgurl=https%3A%2F%2Fimg.freepik.com%2Ffree-photo%2Fclose-up-natural-honey-dipper_23-2148346671.jpg&imgrefurl=https%3A%2F%2Fwww.freepik.com%2Ffree-photos-vectors%2Forganic-honey&docid=DUQ5bFqHng_xoM&tbnid=szb0uX1Gd8NMCM&vet=12ahUKEwiru8zoh5CUAxWkzjgGHcE2I0QQnPAOegQIGhAB..i&w=501&h=626&hcb=2&ved=2ahUKEwiru8zoh5CUAxWkzjgGHcE2I0QQnPAOegQIGhAB'], category: 'food', stock: 40 },
            // Meera's Jewel Box
            ...
            { store: stores[7]._id, name: 'Organic Fresh fruits', description: 'Amazing fruits directly sourced from forest reserves.', price: 900, images: ['https://images.unsplash.com/photo-1587049352851-8d4e89134789?w=600'], category: 'food', stock: 20, isFeatured: true },
